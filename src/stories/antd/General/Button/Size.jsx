    ...
    return (
      <section className="example">
        ...
        <div>
          ...
          <br />
          <br />
          <Button type="primary" size={size} onClick={action('Primary Button Click')}>
            Primary
          </Button>
          <Button className="ml20" size={size} onClick={action('Default Button Click')}>
            Default
          </Button>
          <Button
            className="ml20"
            type="dashed"
            size={size}
            onClick={action('Dashed Button Click')}
          >
            Dashed
          </Button>
          <Button
